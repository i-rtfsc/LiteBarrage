...
public class AppConfig {
    private static final String APP_NAME = "litebarrage";
    private static final String BUGLY_APPID = "eef0521b20";
    ...
    private static void initCrashReport(Context context) {
        ...
        Beta.largeIconId = R.drawable.svg_core_barrage;
        Beta.smallIconId = R.drawable.svg_core_barrage;
        Beta.defaultBannerId = R.drawable.svg_core_barrage;
