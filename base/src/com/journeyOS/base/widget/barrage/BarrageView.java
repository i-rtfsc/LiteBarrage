...
public class BarrageView extends RelativeLayout {
    ...
    public BarrageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            lineHeight = typedArray.getDimensionPixelSize(R.styleable.BarrageView_line_height, UIUtils.dip2px(context, DEFAULT_LINEHEIGHT));
            ...
            if (UIUtils.px2sp(context, lineHeight) < maxTextSize)
                maxTextSize = UIUtils.px2sp(context, lineHeight);
        } finally {
            typedArray.recycle();
        }
    }
    ...
    private void showBarrage(final Barrage tb) {
        ...
        Animation anim = AnimationHelper.createTranslateAnim(getContext(), leftMargin, -UIUtils.getScreenWidth(getContext()));
